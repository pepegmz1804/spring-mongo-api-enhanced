...
class UserControllerIntegrationTest {
    ...
    void updateUser_returnSuccess() throws Exception {
        ...
        User user = userRepository
                .save(new User(null, "Ana", "Lopez", "Martinez", List.of(adminRole.getId())));
    ...
    void getAllUsers_returnSuccess() throws Exception {
        ...
        userRepository.save(new User(null, "Lucia", "Garcia", "Reyes", List.of(role.getId())));
    ...
    void getUserById_returnUser() throws Exception {
        ...
        User user = userRepository
                .save(new User(null, "Carlos", "Ramirez", "Sanchez", List.of(role.getId())));
    ...
    void filterUsersByName_returnSuccess() throws Exception {
        Role role = roleRepository.save(new Role(null, "user", "User"));
        userRepository.save(new User(null, "Mario", "López", "Torres", List.of(role.getId())));
    ...
    void deleteUser_returnSuccess() throws Exception {
        Role role = roleRepository.save(new Role(null, "user", "User"));
        User user = userRepository
                .save(new User(null, "Laura", "Mendoza", "Vargas", List.of(role.getId())));
